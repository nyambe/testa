...
<?php get_template_part( 'include/cabecera', 'paginas' ); ?>
	...
	<div class="not-fullscreen background parallax" style="background-image:url('<?php echo get_template_directory_uri(); ?>/images/teambuilding_atm_1.jpg');" data-img-width="1600" data-img-height="1080" data-diff="100">
	    <div class="content-a">
	        <div class="content-b">
		        <div class="first">
	...
	<div class="not-fullscreen background parallax" style="background-image:url('<?php echo get_template_directory_uri(); ?>/images/teambuilding_atm_2.jpg');" data-img-width="1600" data-img-height="1080" data-diff="100">
	    <div class="content-a">
	        <div class="content-b">
	...
	<div class="not-fullscreen background parallax" style="background-image:url('<?php echo get_template_directory_uri(); ?>/images/teambuilding_atm_3.jpg');" data-img-width="1600" data-img-height="1080" data-diff="100">
	    <div class="content-a">
	        <div class="content-b">
		        <div class="alternativo">
