		...
		<section class="entry-content cf" itemprop="articleBody">
			...
			<div class="head_layout">	
				<div class="eventos-nav">
					<ul class="movil">
						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/movil_mutijornada.png" alt="Elige tu evento movil"></a></li>
						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/movil_kickoff.png" alt="Elige tu evento movil"></a></li>
						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/movil_team.png" alt="Elige tu evento movil"></a></li>
						<li><a href="#"><img src="<?php echo get_template_directory_uri(); ?>/images/movil_gynkana.png" alt="Elige tu evento movil"></a></li>
					</ul> <?php // movil ?>
					<ul class="nomovil" >
						<?php
