<?php get_header(); ?>
<div id="container" class="paginas eventos-de-empresa">	
	...
	<div id="content" class="paginas">
		<section class="slider_container">
			<div id="slider" class="nivoSlider">
				...
				<img src="<?php echo get_template_directory_uri(); ?>/images/eventos1.jpg" title="#subcategorias" alt="slider" />
				<img src="<?php echo get_template_directory_uri(); ?>/images/eventos2.jpg" title="#subcategorias" alt="slider"  />
				<img src="<?php echo get_template_directory_uri(); ?>/images/eventos3.jpg" title="#subcategorias" alt="slider"  />
				<img src="<?php echo get_template_directory_uri(); ?>/images/eventos4.jpg" title="#subcategorias" alt="slider"  />
			</div>
		...
		<section class="entry-content cf" itemprop="articleBody">
			...
			<hr>
			<div class="box">
				<img src="<?php echo get_template_directory_uri(); ?>/images/landing_event_3.jpg" alt="landing3">
			</div>
			...
			<hr>
			<div class="box">
				<img src="<?php echo get_template_directory_uri(); ?>/images/event_box_4.jpg" alt="landing4">
			</div>
			<div class="layout">
